...
(function () {
  ...
  const CLASES_ICONO = { whatsapp: "menu-icon-circle--green", sms: "menu-icon-circle--blue", email: "menu-icon-circle--brand-secondary" };
  ...
  function irAPasoCodigo(info) {
    ...
    if (info.entregado === false && !info.devCode) {
